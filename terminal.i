;*******************************************************************************
;Jump locations for the 42x24 character terminal                               *
;*                                                                             *
...
; for the cursor and enable them.
;***********************************************************************
TERMINAL_INIT:          equ $f000   
 
;***********************************************************************
; Restore the old interrupt handler. Do this before returning to BASIC
; or perform any disk action.
;***********************************************************************
TERMINAL_DISABLE:       equ $f003    

;***********************************************************************
; re-enable interrupt without wiping terminal state
;***********************************************************************
TERMINAL_ENABLE:        equ $f006    

;***********************************************************************
; Print the string referenced in DE
;***********************************************************************
PRINTSTRING:            equ $f009    

;***********************************************************************
; Get the next character from the keyboard buffer or 0
;***********************************************************************
GETNEXTCHAR:            equ $f00C

;***********************************************************************
; Reset the keyboard buffer. 
;***********************************************************************
RESET_KEYBOARD_BUFFER:  equ $f00F   
...
;***********************************************************************
; Scroll the screen downb one line
;***********************************************************************
SCROLL_DOWN:            equ $f015

;***********************************************************************
;Get the location of the terminal variables. 
;***********************************************************************
GET_TERMINALVARS:       equ $f018   
